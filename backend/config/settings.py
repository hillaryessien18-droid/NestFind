...
SPECTACULAR_SETTINGS = {
    "TITLE": "NestFind API",
    "DESCRIPTION": "Real estate platform API for listing, searching, and managing properties.",
    "VERSION": "1.0.0",
...
# Use local filesystem storage by default so uploaded images are stored and
# served from MEDIA_ROOT. Set USE_CLOUDINARY=true to enable Cloudinary instead.
if os.getenv("USE_CLOUDINARY") == "true" and os.getenv("CLOUDINARY_CLOUD_NAME"):
    STORAGES["default"] = {
